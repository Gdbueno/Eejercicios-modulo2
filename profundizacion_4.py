...
hijo=str(input())
nombrep, nombresp, apellidop = nombrepadre.split(" ")
nombrem, nombresm, apellidom =nombremadre.split(" ")
suma = hijo + ' ' + apellidom + ' ' + apellidop
print('el nombre y apellido del hijo es', suma)