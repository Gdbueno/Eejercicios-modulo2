...
nombrecomp = str(input())
#lower
minusculas = nombrecomp.lower()
print ('"Su nombre en minusculas"', minusculas)
#upper
mayusculas = nombrecomp.upper()
print ('"Su nombre en mayusculas"', mayusculas)
#primer letra en mayusculas
primerletra = nombrecomp [:1].upper()
print ('Primer letra en mayuscula es', primerletra)